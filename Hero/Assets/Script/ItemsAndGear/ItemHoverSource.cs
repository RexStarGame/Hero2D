...
public class ItemHoverSource : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerMoveHandler
{
    ...
    public void OnPointerEnter(PointerEventData e) { if (!ItemDragContext.IsDragging && RingSlotUI.DraggedSlot == null) ItemTooltipUI.Instance?.Show(item, e.position, equipped); }
